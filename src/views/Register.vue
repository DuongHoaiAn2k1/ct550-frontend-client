  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row mb-2 border-0 shadow rounded-3 overflow-hidden">
          <div class="card-img-left d-none d-md-flex">
            <!-- Background image for card set in CSS! -->
          </div>
          <div class="card-body p-4 p-sm-5">
            <h2 class="card-title text-center mb-5" style="color: #234A2B; font-weight: 600;">Đăng ký</h2>
            <form @submit="submitSignUp">
              ...
              <div class="form-floating mb-3 row" v-show="otpDisplay">
                <span class="col-3" style="margin-top: 18px; font-size: 20px">OTP:
                </span>
                <input type="text" class="col" id="otpInput" name="otp" v-model="dataSignUp.otp"
                  placeholder="Vui lòng nhập mã OTP" maxlength="6" />
                <span v-show="timeOver > 0" class="col-2" style="margin-top: 18px">{{ timeOver }}s</span>
                <button v-show="timeOver == 0" type="submit" class="col-2" style="
                      margin-top: 18px;
                      margin-right: 12px;
                      border: none;
                      font-size: 16px;
              ...
              <router-link :to="{ name: 'login' }" class="d-block text-center mt-2 small" href="#">Bạn đã có tài khoản?
